...
namespace Catalog.API.Products.DeleteProduct
{
    ...
    public class DeleteProductHandler(IDocumentSession session, ILogger<DeleteProductHandler> logger) : ICommandHandler<DeleteProductComamnd, DeleteProductResult>
    {
